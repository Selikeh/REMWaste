...
function Card({skip, selected, onClick}:{skip:SkipData, selected:boolean, onClick:(skip:SkipData)=>void}) {
  return (
    <li className={` w-fit group rounded-xl col-span-12 md:col-span-6 lg:col-span-4 hover:cursor-pointer hover:bg-darklight-green ${selected?"bg-main-green":""}`} onClick={()=>{onClick(skip)}}>                
